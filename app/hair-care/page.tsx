...
/* ✅ NORMALIZE STRING CATEGORY (STRING COLUMN ONLY) */
...
export default function HairCarePage() {
  ...
  /* ✅ LOAD ONLY "Hair Care" CATEGORY PRODUCTS */
  useEffect(() => {
    (async () => {
      try {
        ...
        const filtered = all.filter((p: any) => {
          ...
          return (
            ...
            normalizeCategory("Hair Care")
          );
        });

        console.log("Hair Care Products:", filtered);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2 max-w-3xl text-sm">
              Discover safe, effective hair care products crafted to nourish,
              strengthen, and protect your hair every day.
            </p>
          </div>
