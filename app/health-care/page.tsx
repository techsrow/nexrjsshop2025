...
export default function HealthCarePage() {
  ...
  /* ✅ LOAD ONLY "Health Care" CATEGORY PRODUCTS */
  useEffect(() => {
    (async () => {
      try {
        ...
        const filtered = all.filter((p: any) => {
          ...
          return (
            ...
            normalizeCategory("Health Care Devices")
          );
        });

        console.log("Health Care Products:", filtered);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2 max-w-3xl text-sm">
              Explore essential healthcare products designed to support your
              daily wellness, recovery, and overall health.
            </p>
          </div>
