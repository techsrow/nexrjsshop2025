...
export default function HijamaPage() {
  ...
  /* ✅ LOAD ONLY "Hijama" CATEGORY PRODUCTS */
  useEffect(() => {
    (async () => {
      try {
        ...
        const filtered = all.filter((p: any) => {
          ...
          return (
            ...
            normalizeCategory("Hijama")
          );
        });

        console.log("Hijama Products:", filtered);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2 max-w-3xl text-sm">
              Discover authentic Hijama (Cupping Therapy) products designed for
              safe, effective, and traditional wellness practices.
            </p>
          </div>
