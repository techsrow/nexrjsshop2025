       ...
       <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2 max-w-3xl text-sm">
              Discover our most loved products, trusted by thousands for their quality, results, and value. These top picks are customer favorites you don’t want to miss.
            </p>
          </div>
