  ...
  (async () => {
    try {
      ...
      const filtered = all.filter((p: any) =>
        p.category?.toLowerCase() === "featured products"
      );
    ...
    <section className="py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4">
       <div className="flex justify-between items-start mb-6">
        ...
        Discover our featured products, carefully selected for their quality, effectiveness, and customer trust. Handpicked essentials you’ll love.
            </p>
          </div>
