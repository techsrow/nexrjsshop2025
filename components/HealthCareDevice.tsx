  ...
  (async () => {
    try {
      ...
      const filtered = all.filter((p: any) =>
        p.category?.toLowerCase() === "health care devices"
      );
    ...
    <section className="py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4">
       <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-2xl font-bold">Health Care Devices</h2>
            <p className="text-gray-600 mt-2 max-w-3xl text-sm">
              Reliable health care devices designed to support accurate monitoring, daily wellness, and better health management at home.
            </p>
          </div>
