    ...
    >
      ...
      <div className="relative z-10 px-6">
        <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-4">
          Experience the<br></br> <span className="text-yellow-300">Art of Smoke</span>
        </h1>
        ...
        <div className="flex justify-center gap-4">
          <a href="/shop" className="bg-gold text-black px-6 py-3 rounded-md font-semibold bg-yellow-500 transition">Shop Now</a>
