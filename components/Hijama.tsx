    ...
    <section className="py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4">
       <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-2xl font-bold">Hijama</h2>
            <p className="text-gray-600 mt-2 max-w-3xl text-sm">
              Hijama is a traditional therapeutic practice that supports natural detoxification, improves circulation, and promotes overall well-being through safe and guided cupping therapy.
            </p>
          </div>
