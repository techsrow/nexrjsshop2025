  ...
  (async () => {
    try {
      ...
      const filtered = all.filter((p: any) =>
        p.category?.toLowerCase() === "skin care"
      );
    ...
    <section className="py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4">
       <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-2xl font-bold">Skin Care</h2>
            <p className="text-gray-600 mt-2 max-w-3xl text-sm">
              Advanced skin treatment solutions designed to target common skin concerns and support healthier, clearer, and more radiant skin.
            </p>
          </div>
